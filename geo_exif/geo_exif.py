...
"""
Uses PIL to read latitude and longitude from EXIF tags.

Adapted from original GitHub gist by @erans at https://gist.github.com/erans/983821
"""
...
if __name__ == "__main__":
    ...
    # Simple example: 'python geo_exif.py foo.jpg'
    import sys, os
    filename = sys.argv[1]
